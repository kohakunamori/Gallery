        ...
        <div className="mt-8 rounded-[32px] bg-surface-container-lowest p-6 shadow-ambient md:p-10">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-7 text-on-surface-variant">
              Select one image or a batch of images. Files are staged temporarily, published to remote
              object storage, then removed from this server. The gallery index stores only remote URLs.
            </p>
          </div>
              ...
              {result.files.map((file) => (
                <li className="py-3 text-sm" key={file.path}>
                  ...
                  <p className="mt-1 text-on-surface-variant">
                    Published as {file.path} · {formatBytes(file.size)}
                  </p>
                </li>
              ))}
            </ul>
